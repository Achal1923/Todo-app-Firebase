...
class task_by_Date_item_List extends StatelessWidget {

  DateTime currSelectedDate;

  task_by_Date_item_List({required this.currSelectedDate});
          ...
          else if(snapshots.hasData || snapshots.data!=null)
          {
            return ListView.separated(
                ...
                itemBuilder: (context,index){
                  ...
                  return taskDate.compareTo(currSelectedDate)==0 ?
                  Ink(padding: EdgeInsets.all(10),
                    decoration: BoxDecoration(
                      color: IsDone ? Colors.green.shade500 : Color(0x99FFFFFF),
                    ...
                    child: ListTile(
                      ...
                      //       context: context,
                      //       builder: (context){
                      //         return EditTodo(editableTitle: title,editableDescription: description,taskDate: taskDate,documentId: docId,);
                      //       }
                      //   );
                      // } ,
